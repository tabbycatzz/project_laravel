...
<body>
    ...
    <section class="breadcrumbbar">
        <div class="container">
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                <li class="breadcrumb-item"><a href="index.html">Tìm kiếm</a></li>
                <li class="breadcrumb-item active"><a href="sach-moi-tuyen-chon.html">Tìm thấy {{ count($products) }} sản phẩm</a></li>
            </ol>
        </div>
    </section>
    ...
    <!-- <section class="banner">
        <div class="container">
            <a href="sach-moi-tuyen-chon.html"><img src="/source/page/images/sach-moi-full-banner.jpg" alt="sach-moi-full-banner" class="img-fluid"></a>
        </div>
    </section> -->
                ...
                <div class="items">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-xs-6">
                            <!-- 1 sản phẩm  -->
                            <div class="card">
                                <a href="{{ route('product.detail', $product->id) }}" class="motsanpham" style="text-decoration: none; color: black;" data-toggle="tooltip" data-placement="bottom" title="">
